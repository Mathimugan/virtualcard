...
return(<React.Fragment>
  ...
  <div class="actions">
    <div id="cta">
      <a id="vcard" href={"https://service.fuyucorp.com:4010/download?name="+data.vcard} rel="noreferrer" download="" target="_blank" aria-label="Save Contact" className="button">
